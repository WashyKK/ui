...
--   discounts              per-product sale prices with a start and end
--   sourcing_requests      "can you get me X" enquiries, tracked to a quote
--   gift_cards             store credit in KSh, redeemed at checkout
--   product_questions      what people ask the assistant, and its rate limit
-- =============================================================================
